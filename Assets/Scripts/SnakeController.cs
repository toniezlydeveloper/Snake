...
public class SnakeController : MonoBehaviour
{
    ...
    {
        if (Input.GetKeyDown(KeyCode.W) && _currentDirection != Direction.Down)
        {
            _currentDirection = Direction.Up;
        }
        if (Input.GetKeyDown(KeyCode.S) && _currentDirection != Direction.Up)
        {
            _currentDirection = Direction.Down;
        }
        if (Input.GetKeyDown(KeyCode.A) && _currentDirection != Direction.Right)
        {
            _currentDirection = Direction.Left;
        }
        if (Input.GetKeyDown(KeyCode.D) && _currentDirection != Direction.Left)
        {
